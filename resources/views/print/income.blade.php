...
<head>
    ...
    <title>Cetak Penerimaan Kas</title>
    ...
    <div class="container-fluid px-0">
        <div class="main-content d-flex flex-column mx-auto py-2 px-3">
            ...
            <div class="text-center mb-4">
                <h3 class="mb-0" style="font-weight: 600; font-size: 18px;">PENERIMAAN KAS</h3>
            </div>

            {{-- Contact Info --}}
            <div class="mb-4">
                <p class="mb-0" style="font-size: 14px;">Diterima dari:</p>
                ...
                <table class="table table-bordered table-sm" style="margin-bottom: 0;">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="text-start" style="width: 150px">Catatan</th>
