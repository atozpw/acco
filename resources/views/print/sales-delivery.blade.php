...
<head>
    ...
    <title>Cetak Pengiriman Barang</title>
    ...
    <div class="container-fluid px-0">
        <div class="main-content d-flex flex-column mx-auto py-2 px-3">
            ...
            <div class="text-center mb-4">
                <h3 class="mb-0" style="font-weight: 600; font-size: 18px;">PENGIRIMAN BARANG</h3>
            </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    <table class="table table-borderless table-sm"
                        style="width: 100%; border-collapse: collapse; font-size: 14px; margin-bottom: 0;">
                        <tr>
                            <td style="width: 150px;">Nomor Pengiriman</td>
                            <td style="width: 16px;">:</td>
            ...
            <div class="mb-4">
                <table class="table table-bordered table-sm" style="margin-bottom: 0;">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center text-muted">Tidak ada detail pengiriman.</td>
                            </tr>
                        @endforelse
                    </tbody>
