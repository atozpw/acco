    ...
    <div class="container-fluid px-0">
        <div class="main-content d-flex flex-column mx-auto py-2 px-3">
            ...
            <div class="text-center mb-4">
                <h3 class="mb-0" style="font-weight: 600; font-size: 18px;">LAPORAN LABA RUGI</h3>
            ...
            <div class="mb-4">
                ...
                <table class="table table-bordered table-sm" style="margin-bottom: 0;">
                    ...
                    <tbody>
                        ...
                        @endforelse
                        @if(!empty($payload['report']['classifications']) && count($payload['report']['classifications']) > 0)
                            <tr class="table-light fw-bold" style="background-color: #e9ecef;">
                                <td class="text-start ps-2">Laba Rugi</td>
                                <td class="text-start" style="width: 50px;">Rp</td>
                                <td class="text-end" style="width: 200px;">
                                    {{ number_format((float) ($payload['report']['totals']['net_profit'] ?? 0), 2, ',', '.') }}
                                </td>
                            </tr>
                        @endif
                    </tbody>
