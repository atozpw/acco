...
<head>
    ...
    <title>Cetak Laba Rugi Perbandingan</title>
        ...
        <div class="main-content d-flex flex-column mx-auto py-2 px-3">
            ...
            <div class="d-flex align-items-center mb-3 pb-3" style="border-bottom: 1px solid #ccc;">
                ...
                <div class="flex-grow-1 ps-3">
                    ...
                    <p class="mb-0" style="font-size: 11px;">Phone: 0851 2116 9627 | Email: info@ardanabalakosapratama.co.id | Web: ardanabalakosapratama.co.id</p>
                </div>
            ...
            <div class="text-center mb-4">
                <h3 class="mb-0" style="font-weight: 600; font-size: 18px;">LABA RUGI PERBANDINGAN</h3>
                <p class="text-muted mb-0" style="font-size: 14px;">Periode berakhir pada {{ $payload['period'] }}</p>
            </div>
            ...
            <div class="mb-4">
                ...
                <table class="table table-bordered table-sm" style="margin-bottom: 0;">
                    ...
                    <tbody>
                        @forelse($payload['report_current_month']['classifications'] ?? [] as $classification)
                            ...
                            @if(!empty($classification['accounts']) && count($classification['accounts']) > 0)
                                @php $renderAccounts($classification['accounts'], 0); @endphp
                            @endif
                        @empty
                            <tr>
                        ...
                        @endforelse
                        @if(!empty($payload['report_current_month']['classifications']) && count($payload['report_current_month']['classifications']) > 0)
                            <tr class="table-light fw-bold" style="background-color: #e9ecef;">
                                <td class="text-start ps-2">Laba Rugi Bersih</td>
                                <td class="text-start" style="width: 25px;">Rp</td>
                                <td class="text-end" style="width: 120px;">
                                    {{ number_format((float) ($payload['report_prev_year']['totals']['net_profit'] ?? 0), 2, ',', '.') }}
                                </td>
                                <td class="text-start" style="width: 25px;">Rp</td>
                                <td class="text-end" style="width: 120px;">
                                    {{ number_format((float) ($payload['report_current_year']['totals']['net_profit'] ?? 0), 2, ',', '.') }}
                                </td>
                                <td class="text-start" style="width: 25px;">Rp</td>
                                <td class="text-end" style="width: 120px;">
                                    {{ number_format((float) ($payload['report_current_month']['totals']['net_profit'] ?? 0), 2, ',', '.') }}
                                </td>
                            </tr>
                        @endif
                    </tbody>
