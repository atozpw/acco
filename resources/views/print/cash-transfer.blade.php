...
<head>
    ...
    <title>Cetak Transfer Kas</title>
    ...
    <div class="container-fluid px-0">
        <div class="main-content d-flex flex-column mx-auto py-2 px-3">
            ...
            <div class="text-center mb-4">
                <h3 class="mb-0" style="font-weight: 600; font-size: 18px;">TRANSFER KAS</h3>
            </div>
                ...
                <div class="col-md-6">
                    <table class="table table-borderless table-sm"
                        ...
                        <tr>
                            ...
                            <td style="width: 16px;">:</td>
                            <td>{{ $payload['department']['name'] ?? 'N/A' }}</td>
                        </tr>
                        <tr>
                            <td style="width: 150px;">Proyek</td>
                            <td style="width: 16px;">:</td>
                            <td>{{ $payload['project']['name'] ?? 'N/A' }}</td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="mb-4">
                <table class="table table-bordered table-sm" style="margin-bottom: 0;">
                    <thead class="table-light">
                        <tr>
                            <th class="text-start" style="width: 115px">Kode Akun</th>
                            <th class="text-start" style="min-width: 225px">Nama Akun</th>
                            <th class="text-start" style="width: 140px">Departemen</th>
                            <th class="text-end" style="width: 175px">Debit</th>
                            <th class="text-end" style="width: 175px">Kredit</th>
                        </tr>
                    </thead>
                    <tbody>
                        @php
                        ...
                        @endphp
                        <tr>
                            <td class="text-start">{{ $payload['to_coa']['code'] ?? '-' }}</td>
                            <td class="text-start">{{ $payload['to_coa']['name'] ?? '-' }}</td>
                            <td class="text-start">{{ $payload['department']['name'] ?? 'N/A' }}</td>
                            <td class="text-end">
                        ...
                        <tr>
                            <td class="text-start">{{ $payload['from_coa']['code'] ?? '-' }}</td>
                            <td class="text-start">{{ $payload['from_coa']['name'] ?? '-' }}</td>
                            <td class="text-start">{{ $payload['department']['name'] ?? 'N/A' }}</td>
                            <td class="text-end">-</td>
                            <td class="text-end">
                                Rp {{ number_format($amount, 0, ',', '.') }}
