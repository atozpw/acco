...
export default function CashTransferIndexScreen({
    cashTransfers,
    filters,
}: {
    cashTransfers: CursorPagination<CashTransferProps>;
    ...
    const [deleteTarget, setDeleteTarget] = useState<CashTransferProps | null>(
        null,
    );
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="px-5 py-6">
                <Heading
                    title="Transfer Kas"
                    description="Mengelola transaksi transfer antar kas/bank"
                />
                ...
                <div className="space-y-6">
                    <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        {hasPermission(['cash-transfers.store']) && (
                            <Button asChild>
                                <Link href={cashTransfer.create().url}>
                    ...
                    <div className="flex items-center justify-end px-2">
                        <div className="flex items-center space-x-6 lg:space-x-8">
                            ...
                            <SimplePaginate
                                prevHref={cashTransfers.prev_page_url}
                                nextHref={cashTransfers.next_page_url}
                            />
                        </div>
                    </div>
                </div>
                    ...
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                ...
                                kas. Anda yakin ingin melanjutkan?
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                            ...
                            <AlertDialogAction
                                onClick={() => {
                                    ...
                                    router.delete(
                                        cashTransfer.destroy(deleteTarget.id)
                                            .url,
                                        {
                                            preserveScroll: true,
                                            onSuccess: () => {
                                            ...
                                            onError: () => {
                                                toast.error('Gagal', {
                                                    description:
                                                        'Terjadi kesalahan saat menghapus transfer kas.',
                                                });
                                            },
                                        },
                                    );
