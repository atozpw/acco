...
export default function CashTransferCreateScreen({
    ...
    const submit: FormEventHandler<HTMLFormElement> = (e) => {
        ...
        post(cashTransfer.store().url, {
            preserveScroll: true,
            onSuccess: () => {
                toast.success('Berhasil', {
                    description: 'Transfer kas berhasil dibuat.',
                });
            },
            onError: () => {
                toast.error('Gagal', {
                    description: 'Terjadi kesalahan saat membuat transfer kas.',
                });
            },
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="px-5 py-6">
                <Heading
                    title="Tambah Transfer Kas"
                    description="Buat baru transaksi transfer antar kas/bank"
                />
                ...
                <form onSubmit={submit} className="space-y-8 xl:px-12">
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <aside className="w-full max-w-xl lg:w-[250px] xl:w-[350px] 2xl:w-md">
                            <HeadingSmall
                                title="Data Umum"
                                description="Masukkan informasi utama"
                            />
                        </aside>
                    ...
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <aside className="w-full max-w-xl lg:w-[250px] xl:w-[350px] 2xl:w-md">
                            <HeadingSmall
                                ...
                                description="Atur akun dan jumlah transfer"
                            />
                        </aside>
                        <Separator className="my-6 lg:hidden" />
                        <div className="flex-1 space-y-6 md:max-w-2xl">
                    ...
                    <div className="mt-8 flex items-center justify-end">
                        <Button
                            ...
                            className="mr-3"
                        >
                            <Link href={cashTransfer.index().url}>Batal</Link>
                        </Button>
