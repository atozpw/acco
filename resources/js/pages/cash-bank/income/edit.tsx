...
export default function IncomeEditScreen({
    ...
    const incomeCoaItems: ComboboxItem[] = coas.map((c) => ({
        value: String(c.id),
        label: `${c.code} - ${c.name}`,
    }));
    ...
    const addRow = () => {
        const newDetail: IncomeDetailForm = {
            coa_id: '',
            amount: '0.00',
            note: '',
            department_id: '1',
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Perbarui penerimaan" />
                ...
                <form onSubmit={submit} className="space-y-8 xl:px-12">
                        ...
                        <div className="flex-1 space-y-6 md:max-w-2xl">
                            ...
                            <div className="grid max-w-2xl gap-2">
                                ...
                                <Textarea
                                    ...
                                    placeholder="Deskripsi singkat penerimaan"
                    ...
                    <div className="flex flex-col space-y-6">
                        <aside className="w-full">
                            <HeadingSmall
                                ...
                                description="Perbarui pembagian akun pendapatan untuk penerimaan ini"
                            />
                        </aside>
                    ...
                    <div className="mt-8 flex items-center justify-end">
                        <Button
                            ...
                            className="mr-3"
                        >
                            <Link href={incomeRoutes.index().url}>Batal</Link>
                        </Button>
