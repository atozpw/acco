...
export default function IncomeIndexScreen({
    ...
    incomes: CursorPagination<IncomeProps>;
    ...
    const [deleteTarget, setDeleteTarget] = useState<IncomeProps | null>(null);
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="px-5 py-6">
                <Heading
                    title="Penerimaan"
                    description="Mengelola transaksi penerimaan kas/bank"
                />
                ...
                <div className="space-y-6">
                    <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        {hasPermission(['incomes.store']) && (
                            <Button asChild>
                                <Link href={income.create().url}>
                    ...
                    <div className="flex items-center justify-end px-2">
                        <div className="flex items-center space-x-6 lg:space-x-8">
                            ...
                            <SimplePaginate
                                prevHref={incomes.prev_page_url}
                                nextHref={incomes.next_page_url}
                            />
                        </div>
                    </div>
                </div>
                    ...
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                ...
                                penerimaan. Anda yakin ingin melanjutkan?
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                            ...
                            <AlertDialogAction
                                onClick={() => {
                                    ...
                                    router.delete(
                                        income.destroy(deleteTarget.id).url,
                                        {
                                            preserveScroll: true,
                                            onSuccess: () => {
