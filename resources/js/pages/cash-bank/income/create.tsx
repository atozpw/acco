...
export default function IncomeCreateScreen({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Buat penerimaan" />

            <div className="px-5 py-6">
                <Heading
                    title="Tambah Penerimaan"
                    description="Buat baru transaksi penerimaan kas/bank"
                />
                ...
                <form onSubmit={submit} className="space-y-8 xl:px-12">
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <aside className="w-full max-w-xl lg:w-[250px] xl:w-[350px] 2xl:w-md">
                            <HeadingSmall
                                title="Data Umum"
                                description="Masukkan informasi utama penerimaan"
                            />
                        </aside>
                    ...
                    <div className="flex flex-col space-y-6">
                        <aside className="w-full">
                            <HeadingSmall
                                ...
                                description="Atur pembagian akun pendapatan untuk penerimaan ini"
                            />
                        </aside>
                    ...
                    <div className="mt-8 flex items-center justify-end">
                        <Button
                            ...
                            className="mr-3"
                        >
                            <Link href={income.index().url}>Batal</Link>
                        </Button>
