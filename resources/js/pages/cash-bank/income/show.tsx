...
export default function IncomeShowScreen({
    income: data,
}: {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Detail Penerimaan ${data.reference_no}`} />

            <div className="px-5 py-6">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <Heading
                        title="Detail Penerimaan"
                        description="Tinjau informasi transaksi penerimaan kas/bank"
                    />
                    <div className="flex gap-3">
                        <Button asChild variant="outline">
                            <Link href={income.index().url}>
                                <Undo2 /> Kembali
                            </Link>
                        </Button>
                        <Button asChild>
                            <Link href={income.edit(data.id)}>
                                <Settings2 />
                                Perbarui
                            </Link>
                        </Button>
