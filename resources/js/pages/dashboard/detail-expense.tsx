...
export default function DetailExpensePage({
    ...
    const headingDescription = period?.label
        ? `Pengeluaran Bulan - ${period.label}`
        : 'Pengeluaran Bulan';
    ...
    const handleNavigate = (target?: PeriodNavigation) => {
        ...
        router.get(dashboard.expense.url(), query, {
            preserveScroll: true,
            preserveState: true,
        });
    };
            ...
            <div className="px-5 py-6">
                    ...
                    <CardContent className="space-y-6">
                        <div className="flex flex-wrap items-center justify-between gap-6">
                            <div className="flex items-start gap-4">
                                <div className="rounded-xl bg-rose-50 p-2 text-rose-600 dark:bg-rose-500/20 dark:text-rose-100">
                        ...
                        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                            <div className="flex flex-col flex-wrap gap-6 text-sm md:flex-row lg:gap-12">
                                ...
                                <div>
                                    ...
                                    <p className="font-semibold">
                                        {formatPercent(
                                            summary?.operational_percentage ??
                                                0,
                                        )}
                                    </p>
                                </div>
                ...
                <Card className="mt-6">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Visualisasi tren pengeluaran per hari atau pekan
                        </CardDescription>
                        <CardAction>
                            <Select
                                value={chartMode}
                ...
                <div className="mt-6 grid gap-6 lg:grid-cols-2">
                    <Card className="dark:bg-sidebar/50">
                        <CardHeader>
                            ...
                            <CardDescription>
                                10 Pengeluaran Departemen Teratas{' '}
                                {periodMonthLabel
                                    ? `- ${periodMonthLabel}`
                                    : ''}
                            </CardDescription>
