...
export default function TaxCreateScreen({
    accounts,
}: {
    accounts: CoaOption[];
}) {
    ...
    const submit: FormEventHandler<HTMLFormElement> = (e) => {
        ...
        post(taxRoute.store().url, {
            preserveScroll: true,
            onSuccess: () => {
                toast.success('Berhasil', {
                    description: 'Data pajak berhasil dibuat.',
                });
            },
            onError: () => {
                toast.error('Gagal', {
                    description: 'Terjadi kesalahan saat membuat data pajak.',
                });
            },
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Buat data pajak" />

            <div className="px-5 py-6">
                <Heading
                    title="Tambah Data Pajak"
                    description="Buat baru data pajak"
                />
                ...
                <form onSubmit={submit} className="space-y-8 xl:px-12">
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <aside className="w-full max-w-xl lg:w-[250px] xl:w-[350px] 2xl:w-md">
                            <HeadingSmall
                                title="Data Umum"
                                description="Masukkan kode, nama, dan persentase pajak"
                            />
                        </aside>
