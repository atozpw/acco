...
export default function PayrollComponentCreateScreen({
    coas,
}: {
    coas: CoaOption[];
}) {
    ...
    const submit: FormEventHandler<HTMLFormElement> = (e) => {
        ...
        post(payrollComponentData.store().url, {
            preserveScroll: true,
            onSuccess: () => {
                toast.success('Berhasil', {
                    description: 'Komponen gaji berhasil dibuat.',
                });
            },
            onError: () => {
                toast.error('Gagal', {
                    description:
                        'Terjadi kesalahan saat membuat komponen gaji.',
                });
            },
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Buat komponen gaji" />

            <div className="px-5 py-6">
                <Heading
                    title="Tambah Komponen Gaji"
                    description="Buat baru komponen gaji"
                />
