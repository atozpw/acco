...
import departmentRoute from '@/routes/department-data';
...
export default function DepartmentIndexScreen({
    departments,
    filters,
}: {
    departments: CursorPagination<DepartmentProps>;
    ...
    const [deleteTarget, setDeleteTarget] = useState<DepartmentProps | null>(
        null,
    );
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="px-5 py-6">
                ...
                <div className="space-y-6">
                    <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            {hasPermission(['departments.store']) && (
                                <Button asChild>
                                    <Link href={departmentRoute.create().url}>
                    ...
                    <div className="flex items-center justify-end px-2">
                        <div className="flex items-center space-x-6 lg:space-x-8">
                            ...
                            <SimplePaginate
                                prevHref={departments.prev_page_url}
                                nextHref={departments.next_page_url}
                            />
                        </div>
                    </div>
                </div>
                ...
                <Dialog open={detailOpen} onOpenChange={setDetailOpen}>
                    <DialogContent>
                        <DialogHeader>
                            <DialogTitle>Detail Departemen</DialogTitle>
                            <DialogDescription>
                                Informasi departemen yang dipilih.
                            </DialogDescription>
                        </DialogHeader>
                        {selectedDepartment && (
                ...
                >
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                Tindakan ini akan menghapus departemen dari
                                daftar. Anda yakin ingin melanjutkan?
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
