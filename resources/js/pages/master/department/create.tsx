...
export default function DepartmentCreateScreen() {
    ...
    const submit: FormEventHandler<HTMLFormElement> = (e) => {
        ...
        post(departmentRoute.store().url, {
            preserveScroll: true,
            onSuccess: () => {
                toast.success('Berhasil', {
                    description: 'Data departemen berhasil dibuat.',
                });
            },
            onError: () => {
                toast.error('Gagal', {
                    description:
                        'Terjadi kesalahan saat membuat data departemen.',
                });
            },
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Buat data departemen" />

            <div className="px-5 py-6">
                <Heading
                    title="Tambah Data Departemen"
                    description="Buat baru data departemen"
                />
                ...
                <form onSubmit={submit} className="space-y-8 xl:px-12">
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <aside className="w-full max-w-xl lg:w-[250px] xl:w-[350px] 2xl:w-md">
                            <HeadingSmall
                                title="Data Umum"
                                description="Masukkan kode, nama, dan status departemen"
                            />
                        </aside>
