...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
        ...
        href: departmentRoute.index().url,
    },
    {
        title: 'Perbarui',
        href: '',
...
export default function DepartmentEditScreen({
    ...
    const submit: FormEventHandler<HTMLFormElement> = (e) => {
        ...
        put(departmentRoute.update(department.id).url, {
            preserveScroll: true,
            onSuccess: () => {
            ...
            onError: () => {
                toast.error('Gagal', {
                    description:
                        'Terjadi kesalahan saat memperbarui data departemen.',
                });
            },
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Perbarui data departemen" />

            <div className="px-5 py-6">
                <Heading
                    title="Perbarui Data Departemen"
                    description="Memperbarui data departemen"
                />
                ...
                <form onSubmit={submit} className="space-y-8 xl:px-12">
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <aside className="w-full max-w-xl lg:w-[250px] xl:w-[350px] 2xl:w-md">
                            <HeadingSmall
                                title="Data Umum"
                                description="Perbarui kode, nama, dan status departemen"
                            />
                        </aside>
                                ...
                                <div className="flex items-center justify-between gap-4">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Tentukan apakah departemen ini aktif
                                            digunakan.
                                        </p>
                                    </div>
                    ...
                    <div className="mt-8 flex items-center justify-end">
                        <Button
                            ...
                            className="mr-3"
                        >
                            <Link href={departmentRoute.index().url}>
                                Batal
                            </Link>
                        </Button>
