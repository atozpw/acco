...
type CashAdvanceClassificationProps = {
    ...
    name: string;
    is_active: boolean;
    incomeCoa?: { id: number; code: string; name: string } | null;
    expenseCoa?: { id: number; code: string; name: string } | null;
};
...
export default function CashAdvanceClassificationIndexScreen({
    classifications,
    filters,
}: {
    classifications: CursorPagination<CashAdvanceClassificationProps>;
    ...
    const [selectedComponent, setSelectedComponent] =
        useState<CashAdvanceClassificationProps | null>(null);
    ...
    useEffect(() => {
        if (
            ...
            router.get(
                cashAdvanceClassification.index(),
                {
                    search: searchBounce,
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Kategori Uang Muka" />

            <div className="px-5 py-6">
                <Heading
                    title="Kategori Uang Muka"
                    description="Mengelola kategori uang muka"
                />
                ...
                <div className="space-y-6">
                    <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            {hasPermission(['cash-advance-classifications.store']) && (
                                <Button asChild>
                                    <Link
                                        href={cashAdvanceClassification.create().url}
                                    >
                                                ...
                                                <DropdownMenu modal={false}>
                                                    ...
                                                    >
                                                        <DropdownMenuGroup>
                                                            ...
                                                            {hasPermission([
                                                                'cash-advance-classifications.update',
                                                            ]) && (
                                                                    <DropdownMenuItem
                                                                        asChild
                                                                    >
                                                                        <Link
                                                                            href={cashAdvanceClassification.edit(
                                                                                item.id,
                                                                            )}
                                                                        >
                                                                            <Settings2Icon />
                                                            ...
                                                            {hasPermission([
                                                                'cash-advance-classifications.destroy',
                                                            ]) && (
                                                                    <DropdownMenuItem
                                                                        onSelect={(
                                                                            event,
                            ...
                            <AlertDialogFooter>
                                ...
                                <AlertDialogAction
                                    onClick={() => {
                                        ...
                                        router.delete(
                                            cashAdvanceClassification.destroy(
                                                deleteTarget.id,
                                            ).url,
                                            {
                                                preserveScroll: true,
                    ...
                    >
                        <DialogContent>
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Informasi lengkap kategori uang muka
                                </DialogDescription>
                            </DialogHeader>
                            {selectedComponent && (
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="grid gap-3 md:grid-cols-2">
                                            <DetailRow
                                                ...
                                                value={formatCoa(
                                                    selectedComponent.incomeCoa,
                                                )}
                                            />
                                            <DetailRow
                                                label="Akun Pengeluaran"
                                                value={formatCoa(
                                                    selectedComponent.expenseCoa,
                                                )}
                                            />
                                        </div>
                                    </div>
                    ...
                    <div className="flex items-center justify-end px-2">
                        <div className="flex items-center space-x-6 lg:space-x-8">
                            ...
                            <SimplePaginate
                                prevHref={classifications.prev_page_url}
                                nextHref={classifications.next_page_url}
                            />
                        </div>
                    </div>
                </div>
