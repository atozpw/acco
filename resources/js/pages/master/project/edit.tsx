...
export default function ProjectEditScreen({
    ...
    const submit: FormEventHandler<HTMLFormElement> = (event) => {
        ...
        put(projectRoute.update(project.id).url, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Perbarui data proyek" />

            <div className="px-5 py-6">
                <Heading
                    title="Perbarui Data Proyek"
                    description="Memperbarui data proyek"
                />
                ...
                <form onSubmit={submit} className="space-y-8 xl:px-12">
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <aside className="w-full max-w-xl lg:w-[250px] xl:w-[350px] 2xl:w-md">
                            <HeadingSmall
                                title="Data Umum"
                                description="Perbarui kode, nama, dan status proyek"
                            />
                        </aside>
