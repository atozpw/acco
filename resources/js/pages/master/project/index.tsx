...
import projectRoute from '@/routes/project-data';
...
export default function ProjectIndexScreen({
    ...
    projects: CursorPagination<ProjectItem>;
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="px-5 py-6">
                <Heading
                    title="Data Proyek"
                    description="Mengelola data proyek"
                />
                ...
                <div className="space-y-6">
                    <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            {hasPermission(['projects.store']) && (
                                <Button asChild>
                                    <Link href={projectRoute.create().url}>
                    ...
                    <div className="flex items-center justify-end px-2">
                        <div className="flex items-center space-x-6 lg:space-x-8">
                            ...
                            <SimplePaginate
                                prevHref={projects.prev_page_url}
                                nextHref={projects.next_page_url}
                            />
                        </div>
                    </div>
                </div>
                ...
                >
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                Tindakan ini akan menghapus proyek dari daftar.
                        ...
                        <AlertDialogFooter>
                            ...
                            <AlertDialogAction
                                onClick={() => {
                                    ...
                                    router.delete(
                                        projectRoute.destroy(deleteTarget.id),
                                        {
                                            preserveScroll: true,
                                            onSuccess: () => {
                                                setDeleteTarget(null);
