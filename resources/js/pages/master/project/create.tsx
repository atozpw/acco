...
export default function ProjectCreateScreen() {
    ...
    const submit: FormEventHandler<HTMLFormElement> = (event) => {
        ...
        post(projectRoute.store().url, {
            preserveScroll: true,
            onSuccess: () => {
                toast.success('Berhasil', {
                    description: 'Data proyek berhasil dibuat.',
                });
            },
            onError: () => {
                toast.error('Gagal', {
                    description: 'Terjadi kesalahan saat membuat data proyek.',
                });
            },
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Buat data proyek" />

            <div className="px-5 py-6">
                <Heading
                    title="Tambah Data Proyek"
                    description="Buat baru data proyek"
                />
                ...
                <form onSubmit={submit} className="space-y-8 xl:px-12">
                    ...
                    <div className="mt-8 flex items-center justify-end">
                        <Button
                            ...
                            className="mr-3"
                        >
                            <Link href={projectRoute.index().url}>Batal</Link>
                        </Button>
