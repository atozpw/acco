...
export default function WarehouseEditScreen({
    ...
    const submit: FormEventHandler<HTMLFormElement> = (event) => {
        ...
        put(warehouseRoute.update(warehouse.id).url, {
            preserveScroll: true,
            onSuccess: () => {
            ...
            onError: () => {
                toast.error('Gagal', {
                    description:
                        'Terjadi kesalahan saat memperbarui data gudang.',
                });
            },
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Perbarui data gudang" />

            <div className="px-5 py-6">
                <Heading
                    title="Perbarui Data Gudang"
                    description="Memperbarui data gudang"
                />
                ...
                <form onSubmit={submit} className="space-y-8 xl:px-12">
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <aside className="w-full max-w-xl lg:w-[250px] xl:w-[350px] 2xl:w-md">
                            <HeadingSmall
                                title="Data Umum"
                                description="Perbarui kode, nama, dan status gudang"
                            />
                        </aside>
