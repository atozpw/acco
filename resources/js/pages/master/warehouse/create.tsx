...
export default function WarehouseCreateScreen() {
    ...
    const submit: FormEventHandler<HTMLFormElement> = (event) => {
        ...
        post(warehouseRoute.store().url, {
            preserveScroll: true,
            onSuccess: () => {
                toast.success('Berhasil', {
                    description: 'Data gudang berhasil dibuat.',
                });
            },
            onError: () => {
                toast.error('Gagal', {
                    description: 'Terjadi kesalahan saat membuat data gudang.',
                });
            },
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Buat data gudang" />

            <div className="px-5 py-6">
                <Heading
                    title="Tambah Data Gudang"
                    description="Buat baru data gudang"
                />
                ...
                <form onSubmit={submit} className="space-y-8 xl:px-12">
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <aside className="w-full max-w-xl lg:w-[250px] xl:w-[350px] 2xl:w-md">
                            <HeadingSmall
                                title="Data Umum"
                                description="Masukkan kode, nama, dan status gudang"
                            />
                        </aside>
                                ...
                                <div className="flex items-center justify-between gap-4">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Tentukan apakah gudang ini aktif
                                            digunakan.
                                        </p>
                                    </div>
                    ...
                    <div className="mt-8 flex items-center justify-end">
                        <Button
                            ...
                            className="mr-3"
                        >
                            <Link href={warehouseRoute.index().url}>Batal</Link>
                        </Button>
