...
import warehouseRoute from '@/routes/warehouse-data';
import { type BreadcrumbItem, type CursorPagination } from '@/types';
...
export default function WarehouseIndexScreen({
    ...
    warehouses: CursorPagination<WarehouseItem>;
    ...
    const [deleteTarget, setDeleteTarget] = useState<WarehouseItem | null>(
        null,
    );
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="px-5 py-6">
                <Heading
                    title="Data Gudang"
                    description="Mengelola data gudang"
                />
                ...
                <div className="space-y-6">
                    <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            {hasPermission(['warehouses.store']) && (
                                <Button asChild>
                                    <Link href={warehouseRoute.create().url}>
                    ...
                    <div className="flex items-center justify-end px-2">
                        <div className="flex items-center space-x-6 lg:space-x-8">
                            ...
                            <SimplePaginate
                                prevHref={warehouses.prev_page_url}
                                nextHref={warehouses.next_page_url}
                            />
                        </div>
                    </div>
                </div>
                        ...
                        <AlertDialogFooter>
                            ...
                            <AlertDialogAction
                                onClick={() => {
                                    ...
                                    router.delete(
                                        warehouseRoute.destroy(deleteTarget.id),
                                        {
                                            preserveScroll: true,
                                            onSuccess: () => {
                                                setDeleteTarget(null);
