...
export default function UnitMeasurementEditScreen({
    unit,
}: {
    unit: UnitMeasurementProps;
}) {
    ...
    const submit: FormEventHandler<HTMLFormElement> = (e) => {
        ...
        put(unitMeasurement.update(unit.id).url, {
            preserveScroll: true,
            onSuccess: () => {
                toast.success('Berhasil', {
                    description: 'Satuan pengukuran berhasil diperbarui.',
                });
            },
            onError: () => {
                toast.error('Gagal', {
                    description:
                        'Terjadi kesalahan saat memperbarui satuan pengukuran.',
                });
            },
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Perbarui satuan pengukuran" />

            <div className="px-5 py-6">
                <Heading
                    title="Perbarui Satuan Pengukuran"
                    description="Memperbarui satuan pengukuran"
                />
                ...
                <form onSubmit={submit} className="space-y-8 xl:px-12">
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <aside className="w-full max-w-xl lg:w-[250px] xl:w-[350px] 2xl:w-md">
                            <HeadingSmall
                                title="Data Umum"
                                description="Perbarui kode, nama, dan status satuan"
                            />
                        </aside>
