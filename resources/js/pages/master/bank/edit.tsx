...
export default function BankEditScreen({
    ...
    const submit: FormEventHandler<HTMLFormElement> = (e) => {
        ...
        put(bankRoute.update(bank.id).url, {
            preserveScroll: true,
            onSuccess: () => {
                toast.success('Berhasil', {
                    description: 'Data bank berhasil diperbarui.',
                });
            },
            onError: () => {
                toast.error('Gagal', {
                    description:
                        'Terjadi kesalahan saat memperbarui data bank.',
                });
            },
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Perbarui data bank" />

            <div className="px-5 py-6">
                <Heading
                    title="Perbarui Data Bank"
                    description="Memperbarui data bank"
                />
                ...
                <form onSubmit={submit} className="space-y-8 xl:px-12">
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <aside className="2xl:w-md w-full max-w-xl lg:w-[250px] xl:w-[350px]">
                            <HeadingSmall
                                title="Data Umum"
                                description="Perbarui kode, nama, dan status bank"
                            />
                        </aside>
                                ...
                                <div className="flex items-center justify-between gap-4">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-muted-foreground text-xs">
                                            Tentukan apakah bank ini aktif
                                            digunakan.
                                        </p>
                                    </div>
