...
import bankRoute from '@/routes/bank-data';
...
export default function BankIndexScreen({
    banks,
    filters,
}: {
    banks: CursorPagination<BankProps>;
    ...
    const [selectedBank, setSelectedBank] =
        useState<BankProps | null>(null);
    const [deleteTarget, setDeleteTarget] = useState<BankProps | null>(
        null,
    );
                ...
                <div className="space-y-6">
                    <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            {hasPermission(['banks.store']) && (
                                <Button asChild>
                                    <Link href={bankRoute.create().url}>
                    ...
                    <div className="flex items-center justify-end px-2">
                        <div className="flex items-center space-x-6 lg:space-x-8">
                            ...
                            <SimplePaginate
                                prevHref={banks.prev_page_url}
                                nextHref={banks.next_page_url}
                            />
                        </div>
                    </div>
                </div>
                ...
                >
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                Tindakan ini akan menghapus bank dari
