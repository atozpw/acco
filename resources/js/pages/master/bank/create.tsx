...
export default function BankCreateScreen() {
    ...
    const submit: FormEventHandler<HTMLFormElement> = (e) => {
        ...
        post(bankRoute.store().url, {
            preserveScroll: true,
            onSuccess: () => {
                toast.success('Berhasil', {
                    description: 'Data bank berhasil dibuat.',
                });
            },
            onError: () => {
                toast.error('Gagal', {
                    description:
                        'Terjadi kesalahan saat membuat data bank.',
                });
            },
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Buat data bank" />

            <div className="px-5 py-6">
                <Heading
                    title="Tambah Data Bank"
                    description="Buat baru data bank"
                />
                ...
                <form onSubmit={submit} className="space-y-8 xl:px-12">
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <aside className="2xl:w-md w-full max-w-xl lg:w-[250px] xl:w-[350px]">
                            <HeadingSmall
                                title="Data Umum"
                                description="Masukkan kode, nama, dan status bank"
                            />
                        </aside>
