...
export default function KontakEditScreen({
    contact,
}: {
    ...
    const { data, setData, put, processing, errors, reset } =
        useForm<ContactFormData>({
            ...
            phone: contact.phone ?? '',
            avatar: null,
            is_customer: Boolean(contact.is_customer),
            is_vendor: Boolean(contact.is_vendor),
    ...
    const submit: FormEventHandler<HTMLFormElement> = (e) => {
        ...
        put(contactData.update(contact.id).url, {
            onSuccess: () => {
            ...
            onError: () => {
                toast.error('Gagal', {
                    description: 'Terjadi kesalahan saat memperbarui kontak.',
                });
            },
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Perbarui data kontak" />
                ...
                <form onSubmit={submit} className="space-y-8 xl:px-12">
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <aside className="w-full max-w-xl lg:w-[250px] xl:w-[350px] 2xl:w-md">
                            <HeadingSmall
                                title="Data Umum"
                                description="Perbarui nama, email dan data umum"
                            />
                        </aside>
