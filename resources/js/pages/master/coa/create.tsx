...
export type CoaParentProps = {
    id: number;
    code: string;
    name: string;
};

export type CoaClassificationProps = {
    id: number;
    name: string;
    type: string;
};
...
export default function CoaCreateScreen({
    parents,
    classifications,
}: {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Buat baru akun" />

            <div className="px-5 py-6">
                <Heading
                    title="Tambah Akun"
                    description="Buat baru data akun"
                />
                ...
                <form onSubmit={submit} className="space-y-8 xl:px-12">
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <aside className="w-full max-w-xl lg:w-[250px] xl:w-[350px] 2xl:w-md">
                            <HeadingSmall
                                title="Data Umum"
                                description="Masukkan kode, nama, dan klasifikasi akun"
                            />
                        </aside>
