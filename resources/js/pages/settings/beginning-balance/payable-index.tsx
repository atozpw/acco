...
export default function BeginningBalancePayableIndex({
    invoices,
}: {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Saldo Awal Utang Usaha" />

            <BeginningBalanceLayout>
                <div className="space-y-6">
                    <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                        <HeadingSmall
                            title="Saldo Awal Utang Usaha"
                            description="Mengisi saldo awal utang usaha"
                        />
                        <Button asChild>
                            <Link href={beginningBalance.payable.create.url()}>
