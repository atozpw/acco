...
export default function UserEditScreen({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs(userRoute.index().url)}>
            <Head title="Perbarui user" />

            <div className="px-5 py-6">
                <Heading
                    title="Perbarui User"
                    description="Ubah identitas, status, atau role user"
                />
                ...
                <form onSubmit={submit} className="space-y-8 xl:px-12">
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <aside className="w-full max-w-xl lg:w-[250px] xl:w-[350px] 2xl:w-md">
                            <HeadingSmall
                                title="Data User"
                                description="Perbarui identitas dan status user"
                            />
                        </aside>
