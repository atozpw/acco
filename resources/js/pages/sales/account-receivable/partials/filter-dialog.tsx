...
export type ReceivableFilterValues = {
    dateRange?: DateRange;
    taxAmount: string;
};

type AccountReceivableFilterDialogProps = {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    trigger: ReactNode;
    taxItems: ComboboxItem[];
    values: ReceivableFilterValues;
    onApply: (values: ReceivableFilterValues) => void;
    onReset: () => void;
};

export default function AccountReceivableFilterDialog({
    open,
    onOpenChange,
    trigger,
    taxItems,
    ...
    onApply,
    onReset,
}: AccountReceivableFilterDialogProps) {
    const [formValues, setFormValues] =
        useState<ReceivableFilterValues>(values);
