...
export default function SalesDeliveryCreateScreen({
    ...
    const handleSubmit: FormEventHandler<HTMLFormElement> = (e) => {
        ...
        post(salesDelivery.store().url, {
            ...
            onError: () => {
                toast.error('Gagal', {
                    description: 'Terjadi kesalahan saat membuat pengiriman.',
                });
            },
        });
    };
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="px-5 py-6">
                <Heading
                    ...
                    description="Buat baru transaksi pengiriman barang"
                />
                ...
                <form onSubmit={handleSubmit} className="space-y-8 xl:px-12">
                    <div className="flex flex-col lg:flex-row lg:space-x-12">
                        <aside className="w-full max-w-xl lg:w-[260px] xl:w-[320px]">
                            <HeadingSmall
                                title="Data Umum"
                                description="Lengkapi informasi utama pengiriman"
                            />
                        </aside>
