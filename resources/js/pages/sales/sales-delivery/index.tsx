...
export default function SalesDeliveryIndexScreen({
    deliveries,
    filters,
}: {
    deliveries: CursorPagination<DeliveryProps>;
    ...
    const [deleteTarget, setDeleteTarget] = useState<DeliveryProps | null>(
        null,
    );
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="px-5 py-6">
                <Heading
                    title="Pengiriman Barang"
                    description="Mengelola transaksi pengiriman barang"
                />
                ...
                <div className="space-y-6">
                    <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        {hasPermission(['sales-deliveries.store']) && (
                            <Button asChild>
                                <Link href={salesDelivery.create().url}>
                    ...
                    <div className="flex items-center justify-end px-2">
                        <div className="flex items-center space-x-6 lg:space-x-8">
                            ...
                            <SimplePaginate
                                prevHref={deliveries.prev_page_url}
                                nextHref={deliveries.next_page_url}
                            />
                        </div>
                    </div>
                </div>
                        ...
                        <AlertDialogFooter>
                            ...
                            <AlertDialogAction
                                onClick={() => {
                                    ...
                                    router.delete(
                                        salesDelivery.destroy(deleteTarget.id)
                                            .url,
                                        {
                                            preserveScroll: true,
                                            onSuccess: () => {
                                            ...
                                            onError: () => {
                                                toast.error('Gagal', {
                                                    description:
                                                        'Terjadi kesalahan saat menghapus pengiriman.',
                                                });
                                            },
                                        },
                                    );
