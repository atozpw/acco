...
export default function ReceivablePaymentIndexScreen({
    payments,
    filters,
}: {
    payments: CursorPagination<ReceivablePaymentProps>;
    ...
    const [deleteTarget, setDeleteTarget] =
        useState<ReceivablePaymentProps | null>(null);
    ...
    const handleDelete = () => {
        ...
        router.delete(receivablePayment.destroy(deleteTarget.id).url, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Pembayaran Piutang Usaha" />

            <div className="px-5 py-6">
                <Heading
                    title="Pembayaran Piutang Usaha"
                    description="Kelola transaksi pembayaran piutang usaha"
                />
                ...
                <div className="space-y-6">
                    <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        {hasPermission(['receivable-payments.store']) && (
                            <Button asChild>
                                <Link href={receivablePayment.create().url}>
