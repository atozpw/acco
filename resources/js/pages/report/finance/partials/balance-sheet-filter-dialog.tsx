...
export type BalanceSheetFilterValues = {
    dateRange?: DateRange;
...
type BalanceSheetFilterDialogProps = {
    open: boolean;
    ...
    customerItems: ComboboxItem[];
    values: BalanceSheetFilterValues;
    onApply: (values: BalanceSheetFilterValues) => void;
    onReset: () => void;
};

export default function BalanceSheetFilterDialog({
    open,
    onOpenChange,
    trigger,
    classificationItems,
    ...
    onApply,
    onReset,
}: BalanceSheetFilterDialogProps) {
    const [formValues, setFormValues] =
        useState<BalanceSheetFilterValues>(values);
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            ...
            <DialogContent className="md:max-w-[520px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Sesuaikan laporan neraca dengan rentang tanggal,
                        klasifikasi, pelanggan, dan parameter lainnya.
                    </DialogDescription>
                </DialogHeader>
                <div className="my-4 space-y-4">
                    <div className="grid gap-2 md:flex md:items-center md:gap-3">
                        <Label className="md:w-[220px]">Rentang Tanggal</Label>
                        <Popover
                    ...
                    <div className="grid gap-2 md:flex md:items-center md:gap-3">
                        <Label className="md:w-[220px]">Pelanggan</Label>
                        <InputCombobox
