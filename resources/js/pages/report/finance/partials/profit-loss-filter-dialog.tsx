...
export type ProfitLossFilterValues = {
    dateRange?: DateRange;
...
type ProfitLossFilterDialogProps = {
    open: boolean;
    ...
    values: ProfitLossFilterValues;
    onApply: (values: ProfitLossFilterValues) => void;
    onReset: () => void;
};

export default function ProfitLossFilterDialog({
    open,
    onOpenChange,
    trigger,
    classificationItems,
    ...
    onApply,
    onReset,
}: ProfitLossFilterDialogProps) {
    const [formValues, setFormValues] =
        useState<ProfitLossFilterValues>(values);
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            ...
            <DialogContent className="md:max-w-[500px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Gunakan filter untuk menyesuaikan laporan laba rugi.
                    </DialogDescription>
                </DialogHeader>
                <div className="my-4 space-y-4">
                    ...
                    <div className="grid gap-2 md:flex md:items-center md:gap-3">
                        <Label className="md:w-[200px]">Klasifikasi</Label>
                        <InputCombobox
