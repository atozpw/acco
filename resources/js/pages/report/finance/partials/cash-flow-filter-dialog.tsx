...
type CashFlowFilterDialogProps = {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    trigger: ReactNode;
    departmentItems: { label: string; value: string }[];
    projectItems: { label: string; value: string }[];
    values: CashFlowFilterValues;
    onApply: (values: CashFlowFilterValues) => void;
    onReset: () => void;
};

export default function CashFlowFilterDialog({
    open,
    onOpenChange,
    trigger,
    departmentItems,
    ...
    onApply,
    onReset,
}: CashFlowFilterDialogProps) {
    const [formValues, setFormValues] = useState<CashFlowFilterValues>(values);
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            ...
            <DialogContent className="md:max-w-[500px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Gunakan filter untuk menyesuaikan laporan arus kas.
                    </DialogDescription>
                </DialogHeader>
