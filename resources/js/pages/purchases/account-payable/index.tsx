...
type PageProps = {
    payables: CursorPagination<PayableRow>;
    filters: PayableFilters;
};

export default function AccountPayableIndexPage({
    payables,
    filters,
}: PageProps) {
    ...
    const handleApplyFilters = (values: PayableFilterValues) => {
        ...
        router.get(accountPayable.index(), query, {
            preserveScroll: true,
            preserveState: true,
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Daftar Utang Usaha" />

            <div className="px-5 py-6">
                <Heading
                    title="Daftar Utang Usaha"
                    description="Menampilkan daftar perinci utang usaha"
                />
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-end px-2">
                        <div className="flex items-center space-x-6 lg:space-x-8">
                            ...
                            <SimplePaginate
                                prevHref={payables.prev_page_url}
                                nextHref={payables.next_page_url}
                            />
                        </div>
                    </div>
                </div>
