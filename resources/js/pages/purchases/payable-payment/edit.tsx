...
export default function PayablePaymentEditScreen({
    payment,
    contacts,
    coas,
    departments,
    ...
    const handleSubmit: FormEventHandler<HTMLFormElement> = (e) => {
        ...
        put(payablePayment.update(payment.id).url, {
            preserveScroll: true,
            onSuccess: () => {
                toast.success('Berhasil', {
                    description: 'Pembayaran utang berhasil diperbarui.',
                });
            },
            onError: () => {
                toast.error('Gagal', {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Perbarui Pembayaran Utang" />

            <div className="px-5 py-6">
                <Heading
                    title="Ubah Pembayaran Utang"
                    description="Perbarui informasi pembayaran utang usaha"
                />
                    ...
                    <div className="flex flex-col space-y-6">
                        <aside className="w-full">
                            <HeadingSmall
                                ...
                                description="Tinjau faktur yang dialokasikan"
                            />
                        </aside>
