...
interface PaymentDetailPayload {
    ...
    purchase_invoice: InvoiceInfo | null;
}
...
export default function PayablePaymentShowScreen({
    payment,
}: {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="px-5 py-6">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <Heading
                        title="Detail Pembayaran Utang"
                        description="Tinjau informasi pembayaran utang usaha"
                    />
                    <div className="flex gap-3">
                        <Button asChild variant="outline">
                            <Link href={payablePayment.index().url}>
                                <Undo2 />
                                Kembali
                            </Link>
                        </Button>
                        <Button asChild>
                            <Link href={payablePayment.edit(payment.id).url}>
                                <Settings2 />
                                Perbarui
                            </Link>
                        </Button>
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {details.length === 0 ? (
                                ...
                                details.map((detail) => {
                                    const invoice = detail.purchase_invoice;
