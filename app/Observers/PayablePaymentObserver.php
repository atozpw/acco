    ...
    public function created(PayablePayment $payablePayment): void
    {
        ...
        foreach ($payablePaymentDetails as $payablePaymentDetail) {
            $journalDetails[] = [
                ...
                'credit' => 0,
                'note' => $payablePaymentDetail->note ?? $payablePayment->description,
                'department_id' => $payablePaymentDetail->department_id,
                'project_id' => $payablePaymentDetail->project_id,
        ...
        $journalDetails[] = [
            ...
            'note' => $payablePayment->description,
            'department_id' => $payablePayment->department_id,
            'project_id' => $payablePayment->project_id,
            'created_by' => $payablePayment->created_by,
