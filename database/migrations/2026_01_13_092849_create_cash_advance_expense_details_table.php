...
return new class extends Migration
{
    ...
    {
        Schema::create('cash_advance_expense_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('cash_advance_expense_id');
    ...
    {
        Schema::dropIfExists('cash_advance_expense_details');
    }
};
