...
Route::middleware('auth')->prefix('report')->group(function () {
    ...
    Route::prefix('financial-statement')->group(function () {
        ...
        Route::get('profit-loss-comparison', [FinancialStatementController::class, 'profitLossComparison'])
            ->name('financial-statement.profit-loss-comparison')
            ->middleware(['permission:financial-statement.profit-loss']);
        ...
        Route::get('balance-sheet-comparison', [FinancialStatementController::class, 'balanceSheetComparison'])
            ->name('financial-statement.balance-sheet-comparison')
            ->middleware(['permission:financial-statement.balance-sheet']);
